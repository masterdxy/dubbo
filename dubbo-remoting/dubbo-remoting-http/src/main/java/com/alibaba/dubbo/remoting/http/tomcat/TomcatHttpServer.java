...
public class TomcatHttpServer extends AbstractHttpServer {
    ...
    public TomcatHttpServer(URL url, final HttpHandler handler) {
        ...
        tomcat.getConnector().setProperty(
                "acceptCount", String.valueOf(url.getParameter(Constants.ACCEPTS_KEY, -1)));
        tomcat.getConnector().setProperty(
        ...
        tomcat.getConnector().setProperty("acceptorThreadCount", String.valueOf(Runtime.getRuntime().availableProcessors()));
